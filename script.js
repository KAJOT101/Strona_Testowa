...
const teamData = {
    ...
    'dagmara': {
        ...
        courses: [
            '04.2007 -Kurs masażu leczniczego II stopnia BIO-RELAX',
            '05.2007 - Kurs masażu leczniczego IV stopnia BIO-RELAX',
            '06.2007 - Kurs masażu leczniczego V stopnia BIO-RELAX',
            '10.2009 -Brian Mulligan`s Concept -A Mobilisations With Movement R.J.E.M. Claassen',
            '01.2010 - Brian Mulligan`s Concept -B Mobilisations With Movement R.J.E.M. Claassen',
            '05.2010 - Diagnoza i leczenie zespołów bólowych kręgosłupa i kończyn metodą McKenziego A',
            '10.2010 - Diagnoza i leczenie zespołów bólowych kręgosłupa i kończyn metodą McKenziego B',
            '04.2011 - Diagnoza i leczenie zespołów bólowych kręgosłupa i kończyn metodą McKenziego C',
            '11.2011 - Diagnoza i leczenie zespołów bólowych kręgosłupa i kończyn metodą McKenziego D',
            '01.2012 - Proprioceptive Neuromuscular Facilitation (M. Knott Concept) PNF podstawowy mgr Katarzyna Michaluk',
            '07.2015 - „PNF i skoliozy” mgr Katarzyna Michaluk',
            '10.2015 - Seminarium wprowadzające do „Terapii Integracji Sensorycznej Ayres SIAT Pegagogiki',
            'Integracyjno-Sensorycznej SIPad - Kristiane Kull-Sadacharam',
            '10.2015 - „Wybrane tematy z fizjoterapii pediatrycznej, integracja sensoryczna”- Reha+',
            '11.2015 - Kinezjotaping 2015r - Reha+',
            '04.2016 - I Moduł Medycyny Ortopedycznej wg dr J. Cyriax`a mgr Grzegorz Gałuszka',
            '06.2016 - II Moduł Medycyny Ortopedycznej wg dr J. Cyriax`a mgr Grzegorz Gałuszka',
            '10.2017- IV Moduł Medycyny Ortopedycznej wg dr J. Cyriax`a mgr Grzegorz Gałuszka',
            '11.2018 - III Moduł Medycyny Ortopedycznej wg dr J. Cyriax`a mgr Grzegorz Gałuszka',
            '07.2020 - „Uszkodzenie rdzenia kręgowego - postępowanie terapeutyczne” - Benedikt Bomer, PT',
            '08.2020 - IPNFA- Advanced Course (Level 3A) Proprioceptive Neuromuscular Facilitation (M. Knott Concept) PNF rozwijający MSc, PT, IPNFA Advanced Instructor Matthias Schulte',
            '05.2021 - V Moduł Medycyny Ortopedycznej wg dr J. Cyriax`a mgr Grzegorz Gałuszka',
            '05.2021 - „Kończyna górna po udarze” - mgr Joanna Tokarska MSc PT',
            '03.2022 - „Kończyna dolna po udarze” - mgr Joanna Tokarska MSc PT',
            '09.2022 - „Terapia wisceralna w praktyce fizjoterapeuty” - mgr Marcin Szkolnicki',
            '11.2023 - „Wczesna rehabilitacja po udarze” - mgr Joanna Tokarska MSc PT',
            '06.2024 - „Osteopatyczne podejście do zaburzeń psychosomatycznych (BASIC)” - J. Stępniak D.O.',
            '12.2024 - Terapia bazalna - dr Grzegorz Biliński',
            '02.2025 - BAC- Body Alignment Concept - REHAINTEGRO',
            '10.2025 -„Stopa dziecka - diagnoza i terapia” - ODNOVA'
        ],
        prices: [
            { name: "Wizyta osteopatyczna", price: "200 PLN" },
